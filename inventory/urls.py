...
urlpatterns = [
    ...
    path('download-price-chart/', views.download_price_chart, name='download_price_chart'),
    path('download-purchase-sum-by-category/', views.download_purchase_sum_by_category,name='download_purchase_sum_by_category'),
