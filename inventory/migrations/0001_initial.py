# Generated by Django 5.0.6 on 2024-10-27 17:08
...
def create_initial_data(apps, schema_editor):
    ...
    Supplier.objects.bulk_create([
        Supplier(name='Dostawca A', contact_info='dostawcaA@example.com'),
        Supplier(name='Dostawca B', contact_info='dostawcaB@example.com'),
        Supplier(name='Dostawca C', contact_info='dostawcaC@example.com'),
    ])
